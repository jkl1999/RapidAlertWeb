...
import './App.css';
import AccountPageScreen from './AccountPageScreen.js';
import Create2Screen from './Create2Screen.js';
import Create1Screen from './Create1Screen.js';
...
export default class App extends Component {
  constructor(props) {
    ...
    this.dataSlots['ds_userAcceptedContract'] = "false";
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      let screenProps = {
        ...
        ds_userAcceptedContract: this.dataSlots['ds_userAcceptedContract'],
      };
      switch (screenId) {
        default:
          return null;
        case 'accountpage':
          return (<AccountPageScreen {...screenProps} />)
        case 'create2':
          return (<Create2Screen {...screenProps} />)
        case 'create1':
          return (<Create1Screen {...screenProps} />)
